...
(function(){
  ...
  window.axwsAfterView=function(id){
    ...
    // nuqsonni beradi. Bounded flex launcher/history uchun xavfsiz, shuning
    // uchun UXP'da AI ochilgan zahoti uni doimiy saqlaymiz.
    if(window.__FFNodeIO)toolLayout=true;
    ...
    // Premiere 26.2 UXP yangi flex view'ni DOM'da to'g'ri yoqadi, lekin ba'zan
    // layoutni talab qilmaguncha uning paint qutisini qora qoldiradi. Spike'da
    // offsetHeight doim 0; getBoundingClientRect esa haqiqiy layout barrier.
    // Root opacity/visibility flip yo'q — faqat yangi view'ning o'zi o'qiladi.
    // Bu faqat composer emas: launcher/history/settings qaytishlari ham barrier
