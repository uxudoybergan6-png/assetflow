...
VIEWS.plans = function () {
  ...
  return `<div class="col gap-20">
    ${infoBanner(`${ic("plugin")}<span><b>AE Browse</b> faqat <b>Free</b> va <b>Pro</b> rejimda. Narxlar va limitlar shu yerda saqlanadi (hozircha brauzer cache; Stripe ulangach serverdan).</span>`)}
    ...
    <div class="card card-pad">
      <div class="row between center wrap gap-12">
        <div class="col gap-4">
          ...
          <span class="small">O‘zgarishlar admin panel va plugin narx ko‘rinishiga tatbiq qilinadi.</span>
        </div>
        <div class="row gap-8">
